...
#
wsi_path = '/home/afridi/Desktop/path-data-processing/data_wsi/images/test'
xml_path = '/home/afridi/Desktop/path-data-processing/data_wsi/annotations/test'
...
for wsi in os.listdir(wsi_path):
    ...
    wsi_name = target_dir+'/'+ 'test_patches/'
    wsi_name_gt = target_dir+'/'+ 'test_gt/'
